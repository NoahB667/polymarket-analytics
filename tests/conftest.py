...
# Attempt to import signal_core; only mock if import fails (genuine fallback)
try:
    import signal_core.order_flow
except ImportError:
    # signal_core is not available in this environment; install mock as fallback
